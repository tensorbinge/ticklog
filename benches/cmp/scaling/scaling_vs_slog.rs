//! Rust ecosystem comparison: `slog` multi-thread scaling.
...
fn bench_slog_scaling(c: &mut Criterion) {
    ...
    let mut g = c.benchmark_group("scaling_slog");

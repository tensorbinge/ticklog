//! Rust ecosystem comparison: `tracing` multi-thread scaling.
...
fn bench_tracing_scaling(c: &mut Criterion) {
    ...
    let mut g = c.benchmark_group("scaling_tracing");
